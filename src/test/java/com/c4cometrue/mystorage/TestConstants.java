...
public class TestConstants {
    ...
    public static final Long NOT_USERS_ROOT_ID = 2L;
    public static final Long NON_MATCHING_USER_ID = 2L;
    public static final String STORED_ROOT_FOLDER_NAME = RootFolderMetadata.storedName();
    ...
    public static final FolderMetadata FOLDER_METADATA =
        FolderMetadata.builder().parentId(PARENT_ID).rootId(ROOT_ID).uploaderId(USER_ID).build();

    public static final Long FOLDER_ID = 1L;

    public static final FolderNameChangeRequest FOLDER_NAME_CHANGE_REQUEST =
        FolderNameChangeRequest.of(USER_ID, FOLDER_ID, USER_FOLDER_NAME);
}
